...
public class UnlockCommand implements CommandExecutor {
	...
	public void removeTimeLock(Player player) {
		...
		if (LockCommand.TimeLocked.containsKey(world)) {
			...
			player.sendMessage(FPSettings.timeunlock.replace("@w", player
					.getWorld().getName()));
		} else {
			player.sendMessage(FPSettings.timenotlocked.replace("@w", player
					.getWorld().getName()));
		}
	}
	...
	public void removeWeatherLock(Player player) {
		...
		if (LockCommand.WeatherLocked.containsKey(world)) {
			...
			player.sendMessage(FPSettings.weathernotlocked.replace("@w", player
					.getWorld().getName()));
		}
	}
}