                    ...
                    try {
                        ...
                        if (account.hasEnough(FPSettings.LotteryCost)) {
                            if (Integer.parseInt(args[1]) == code) {
                                ...
                                player.sendMessage(FPSettings.LotteryWin.replace("@b", String.valueOf(account.balance())));
                                ...
                                player.sendMessage(FPSettings.LotteryLoss.replace("@b", String.valueOf(account.balance())));
                            }
                        } else {
